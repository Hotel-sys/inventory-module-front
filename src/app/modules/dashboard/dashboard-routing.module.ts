...
const routes: Routes = [
  {
    ...
    children: [
      { path: '', component: AnalyticsComponent, resolve: { analytics: analyticsResolver } },
      { path: 'companies', component: CompaniesComponent },
      { path: 'departments', component: DepartmentsComponent },
      { path: 'expenses', component: ExpensesComponent, resolve: { expenses: expensesResolver } },
      { path: 'stock-items', component: StockItemsComponent, resolve: { expenses: stockItemsResolver } },
