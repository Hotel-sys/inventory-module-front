...
export class UbBreadcrumbLinkDirective {
  ...
  protected computedClass = computed(() => cn('hover:text-foreground transition-colors', this.class()));
}
...
export class UbBreadcrumbPageDirective {
  ...
  protected computedClass = computed(() => cn('text-foreground font-normal', this.class()));
}
...
export class UbBreadcrumbEllipsisComponent {
  ...
  protected computedClass = computed(() => cn('flex size-9 items-center justify-center', this.class()));
}
